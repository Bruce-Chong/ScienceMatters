    ...
    for row in db_data:
        ...
        #deleted the case for IMG
            ...
            messages = f"""
               ...
               In determining the key points, do take note of key scientific terms and descriptions. Be very precise. For example, air is not the same as water vapour, and vice versa.
